...
const Consoles = () => {
    return (
        ...
        <ConsoleContent 
            ...
            conPar3='This battle, most fiercely fought in North America, was not only good for profits but it was the catalyst for taking the image of gaming away from the player in seclusion to the masses where it is today, and oh yes, introduced us to the to the phenomenon that is Sonic The Hedgehog.'
        />
        <Footer/>
        </>
    )
